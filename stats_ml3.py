...
# %%
mean_pred = knn.predict(test_x)
# mean_data.shape
# %%
# 性能評価
print("正解率: " + str(round(accuracy_score(test_y, mean_pred), 3)))
print("適合率: " + str(round(precision_score(test_y, mean_pred, average="macro"), 3)))
print("再現率: " + str(round(recall_score(test_y, mean_pred, average="macro"), 3)))
